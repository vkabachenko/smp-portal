...
class ExcelAct extends ExcelActTemplate
{
    ...
    protected function getParams()
    {
        ...
        return [
            ...
            '{defect_warranty}' => $this->bid->defect_manufacturer,
            '{diagnostic_warranty}' => $this->bid->diagnostic_manufacturer,
            '{isWarranty}' => $this->bid->isWarranty() ? 'Да' : '',
            '{isPostPurchase}' => !$this->bid->isWarranty() ? 'Да' : '',
            '{defect}' => $this->bid->defect_manufacturer,
            '{diagnostic}' => $this->bid->diagnostic_manufacturer,
